 ...
 * Matrix invertor;
 * 
 * This class implements Strategy desing pattern;
 * 
...
public interface MatrixInvertor {
	 ...
	 * Inverse the matrix;
	 * 
	 * @param matrixInversion to be inverted
	 * @return inverted matrix
	 * @throws MatrixInversionException
	 */
	public Matrix inverse(MatrixInversion matrixInversion) throws MatrixInversionException;
