...
object TR {
  ...
  val chartView = TypedResource[speedlab4.ui.chart.ChartView](R.id.chartView)
  ...
  val reset = TypedResource[android.widget.Button](R.id.reset)
  val popview = TypedResource[speedlab4.ui.LatticeView](R.id.popview)
  val restart = TypedResource[android.widget.Button](R.id.restart)
 object layout {
